...
5. **Find or infer the diff artifact.** Look for a `generated_diff` artifact in the repository that traces to the execution plan. If none exists, use "GD-pending" as the subject_diff and note this in the evidence.
